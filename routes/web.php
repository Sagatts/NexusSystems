...
Route::middleware(['auth', 'role:administrador'])
    ...
    ->group(function () {
        ...
        // PRODUCTOS
        Route::get('productos-datatable', [ProductoController::class, 'getProductos'])
        ...
        Route::prefix('reportes')->name('reportes.')->group(function () {
            ...
            Route::get('/configurar', [ReporteController::class, 'create'])
                ->name('create');

            Route::get('/exportar', [ReporteController::class, 'exportar'])
                ->name('exportar');

            Route::get('/previa-pdf', [ReporteController::class, 'previaPdf'])
                ->name('previa.pdf');
        });
    });
...
Route::post('/pedidos/procesar', [PedidoController::class, 'procesarPedido'])
